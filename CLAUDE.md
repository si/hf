...
- Taylan's sets blend house with garage (skippy, swung rhythms), distinct from the disco-leaning club house the rest of the crew typically play — reflect that in his intros rather than defaulting to the generic "uplifting/disco-tinged" language used for other residents.
